    ...
    internal static class LocalisationData
    {
            ...
            new Dictionary<string, Dictionary<string, string>>
        {
            ["en-US"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+Click: cancel entire construction queue",
            ...
            ["de-DE"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+Klick: gesamte Bauwarteschlange abbrechen",
            ...
            ["es-ES"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+Clic: cancelar toda la cola de construcci\u00f3n",
            ...
            ["fr-FR"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Maj+Clic: annuler toute la file de construction",
            ...
            ["it-IT"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+Clic: annulla intera coda di costruzione",
            ...
            ["jp-JP"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+\u30af\u30ea\u30c3\u30af: \u5efa\u8a2d\u4e88\u5b9a\u3092\u3059\u3079\u3066\u30ad\u30e3\u30f3\u30bb\u30eb",
            ...
            ["ko-KO"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+\ud074\ub9ad: \uac74\uc124 \ub300\uae30\uc5f4 \uc804\uccb4 \ucde8\uc18c",
            ...
            ["pl-PL"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+klik: anuluj ca\u0142\u0105 kolejk\u0119 budowy",
            ...
            ["pt-BR"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+Clique: cancelar toda a fila de constru\u00e7\u00e3o",
                ["SimpleTweaks.Tooltip.DeleteAsteroid"]        = "Destruir objeto",
            ...
            ["ru-RU"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+\u041a\u043b\u0438\u043a: \u043e\u0442\u043c\u0435\u043d\u0438\u0442\u044c \u0432\u0441\u044e \u043e\u0447\u0435\u0440\u0435\u0434\u044c \u0441\u0442\u0440\u043e\u0438\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u0430",
            ...
            ["tr-TR"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+T\u0131kla: t\u00fcm in\u015faat s\u0131ras\u0131n\u0131 iptal et",
            ...
            ["zh-CN"] = new Dictionary<string, string>
            {
                ...
                ["SimpleTweaks.Tooltip.CancelAllConstruction"] = "Shift+\u70b9\u51fb: \u53d6\u6d88\u6574\u4e2a\u5efa\u9020\u961f\u5217",
