...
namespace SimpleTweaks
{
    ...
    public static class Patch_SearchRow_Start
    {
        ...
        // ─────────────────────────────────────────────────────────────────────────
        // Feature 9b (removed): facility-row X button only exists in open beta
        // (0.26.5.15.14+).  Not applicable to game 0.26.4.29.
        // ─────────────────────────────────────────────────────────────────────────
        ...
        public static class Patch_UIFacilityList_SetData_Tooltip
        {
            static void Postfix(UIFacilityList __instance)
            {
                try
                {
                    ...
                    {
                        // Use Traverse for non-beta compat: ButtonCancel property
                        // only exists in 0.26.5.15.14+ (open beta).
                        var btn = Traverse.Create(row)
                            .Property("ButtonCancel")?.GetValue<UnityEngine.UI.Button>();
